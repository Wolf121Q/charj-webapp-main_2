        ...
        <div className="bg-white py-10  h-full">
            <div className="container mx-auto">
                <div className="grid gap-y-9">
                    <h2 className="text-[32px] md:text-4xl xl:text-[44px] 2xl:text-5xl text-center text-[#338000]">LEARN OUR INDUSTRY</h2>
                        ...
                        <div className="flex flex-wrap justify-center">
                            {IndustryInsightsData.map((data, index) =>
                                <div className="w-full md:w-1/2 lg:w-1/3 p-4 text-center" key={index}>
                                    <h4 className="text-2xl text-[#547b3f] leading-6 h-16">{data.name}</h4>
