...
const Footer = (props) => {
  return (
    <div className={props.className}>
      ...
      <div className={`flex ${!props.isHomePage ? 'flex-col' : 'flex-col lg:flex-row'} items-center justify-between py-6 px-10 bg-white gap-3`}>
        {props.isHomePage && <h1 className="text-md font-bold text-black text-center tracking-widest">Copyright © 2023 CHARJ.co by Orbitunity Inc. and Incu Canada</h1>}
        <h1 className="text-md font-light text-[#338000] tracking-widest flex items-end">Powered by <Link to="https://claystone.pk/" target="_blank"><img src={poweredLogo} alt="clay stone logo" className="h-6" /></Link></h1>
      </div>
    </div>
  );
